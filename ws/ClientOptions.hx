...
typedef ClientOptions = {
	...
	var family : Float;
	@:optional
	function checkServerIdentity(servername:String, cert:CertMeta):Bool;
	@:optional
	...
	**/
	@:optional
	var ca : ts.AnyOf3<String, Buffer, Array<ts.AnyOf2<String, Buffer>>>;
	/**
	...
	**/
	@:optional
	var cert : ts.AnyOf3<String, Buffer, Array<ts.AnyOf2<String, Buffer>>>;
	/**
	...
	**/
	@:optional
	var crl : ts.AnyOf3<String, Buffer, Array<ts.AnyOf2<String, Buffer>>>;
	/**
	...
	**/
	@:optional
	var dhparam : ts.AnyOf2<String, Buffer>;
	/**
	...
	**/
	@:optional
	var key : ts.AnyOf3<String, Buffer, Array<ts.AnyOf2<Buffer, /*js.node.tls.KeyObject*/Any>>>;
	/**
	...
	**/
	@:optional
	var maxVersion : /*js.node.tls.SecureVersion*/Any;
	/**
	...
	**/
	@:optional
	var minVersion : /*js.node.tls.SecureVersion*/Any;
	/**
	...
	**/
	@:optional
	var pfx : ts.AnyOf3<String, Buffer, Array<ts.AnyOf3<String, Buffer, /*js.node.tls.PxfObject*/Any>>>;
	/**
